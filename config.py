...
# 主筋標準彎鉤預設值 (cm)
MAIN_REBAR_HOOK_LENGTHS = {
    "normal": {
        "#3": 15, "#4": 20, "#5": 25, "#6": 30, "#7": 35,
        "#8": 40, "#9": 50, "#10": 55, "#11": 60
    },
    "plus_1": {
        "#3": 16, "#4": 21, "#5": 26, "#6": 31, "#7": 36,
        "#8": 41, "#9": 50, "#10": 56, "#11": 61
    },
    "plus_5": {
        "#3": 20, "#4": 25, "#5": 30, "#6": 35, "#7": 40,
        "#8": 45, "#9": 55, "#10": 60, "#11": 65
    }
}

SUB_REBAR_HOOK_LENGTHS = {
        "#3": 10, "#4": 12, "#5": 15, "#6": 19, "#7": 23,
        "#8": 27, "#9": 31, "#10": 35, "#11": 40
} 